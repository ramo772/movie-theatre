...
<label class="form-label form-label-lg " for="FirstName">Day</label>
<select id="sel_day-{{ $movie->id }}" name="day_id" class="form-control" data-movie-id="{{ $movie->id }}">
...
<select name="show_time_id" class="form-control" id="sel_time-{{ $movie->id }}">
